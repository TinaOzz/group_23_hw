...
#  то вывести в консоль (“Переменная item_1 меньше”, comp_item), иначе,
#  вывести в консоль (“Переменная item_1 больше или равна”, comp_item)
if item_1 < comp_item:
    print(f'Переменная item_1 меньше {comp_item}')
else:
   print(f'Переменная item_1 больше или равна {comp_item}')
...
#                     то в теле этого if в  значении переменной currency_result высчитать
...
#                     долларов получится при target_currency_amount и usd_uah_rate.
...
if  currency_convertor:
    ...
    if target_currency == 'eur':
        ...
        print(f'{target_currency_amount} {eur_item} = {currency_result} {usd_item}')
