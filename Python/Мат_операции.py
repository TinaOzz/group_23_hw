...
#  5.Создать переменную result_subtr в которой вы вычитаете большую по значению переменную
# из меньшей по значению.
#  6. Вывести в консоль
...
# 11. Создать переменную result_m_exp в которой вы item_1 возводите в степень item_2 используя
# библиотеку math.
...
# 13. Создать переменную result_s_root в которой вы найдёте квадратный корень
# любой из переменной item
...
# 23. Создать переменную result_m_floor и result_division округлить до ближайшего целого
# меньшего чем result_division.
# 24. Вывести result_m_floor в консоль.

result_m_floor = math.floor(1.8) # = 1
...
result_int = round(1.8) # = 2
print(result_int)

 # 29. Создать переменную result_no_division_loss в которой вы разделите item_1 на item_2
# без остатка.
